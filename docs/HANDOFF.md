...
## Phase 68 - 문서·인코딩 정리 ✅ 완료 (2026-05-27)
...
| 항목 | 변경 파일 | 내용 |
|---|---|---|
| CRLF 인코딩 점검 | — | `git diff --check` 통과. Phase 66 `.gitattributes` 이미 처리 |
| RUNBOOK.md | — | Phase 66에서 이미 전면 현행화 완료. 추가 변경 불필요 |
| TASKS.md | `docs/TASKS.md` | Phase 66/67 완료 기록 + Phase 68 in-progress 항목 상단 추가 |
| ARCHITECTURE.md | `docs/ARCHITECTURE.md` | `map.spec.ts` E2E 항목 추가 (테스트 수 254/20 이미 동기화) |
| README.md | `README.md` | 테스트 수 253→254, E2E 16→20 수정 |

**테스트**: 유닛 **254개** 통과 · 코드 변경 없음
