...
export const MOCK_PLACES: NormalizedPlace[] = [
  ...
  {
    id: 'mock-2',
    slug: 'seongdong-wangsimni-library',
    sourceType: 'MOCK',
    name: '성동구립 왕십리도서관',
    category: 'library',
    district: '성동구',
    address: '서울 성동구 왕십리광장로 22',
    latitude: 37.5617,
    longitude: 127.0374,
    isFree: true,
    openTimeText: '09:00',
    closeTimeText: '21:00',
    description: '왕십리역 인근 성동구립 공공도서관. 열람실·어린이실·디지털자료실 운영.',
    imageUrl: 'https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=400&h=280&fit=crop',
    tags: ['indoor', 'wheelchair', 'wifi'],
    nearestStation: '2·5호선 왕십리역 도보 3분',
  },
  {
    id: 'mock-20',
  ...
  {
    id: 'mock-14',
    slug: 'taereung-international-tennis',
    sourceType: 'MOCK',
    name: '태릉국제테니스장',
    category: 'sports',
    district: '노원구',
    ...
    longitude: 127.0944,
    isFree: false,
    feeText: '1시간 2,000~3,000원',
    openTimeText: '07:00',
    closeTimeText: '21:00',
    description: '국제 규격 하드코트 10면 보유. 생활체육 예약제 운영.',
    imageUrl: 'https://images.unsplash.com/photo-1542144582-1ba00456b5e3?w=400&h=280&fit=crop',
    tags: ['outdoor'],
    nearestStation: '6호선 태릉입구역 도보 10분',
  },
  {
    id: 'mock-15',
    slug: 'gangnam-sports-center',
    sourceType: 'MOCK',
    name: '강남구민체육센터',
    category: 'sports',
    district: '강남구',
    address: '서울 강남구 학동로 452',
    latitude: 37.5154,
    longitude: 127.0289,
    isFree: false,
    feeText: '수영 1회 3,000원 / 헬스 월 40,000원',
    openTimeText: '06:00',
    closeTimeText: '22:00',
    description: '수영장·헬스장·에어로빅·스쿼시 운영 강남구 공식 구민체육센터.',
    imageUrl: 'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=400&h=280&fit=crop',
    tags: ['indoor', 'wheelchair'],
    nearestStation: '7호선 논현역 도보 10분',
  },
  {
    id: 'mock-29',
    slug: 'jamsil-olympic-indoor-pool',
    sourceType: 'MOCK',
    name: '잠실종합운동장 실내수영장',
    category: 'sports',
    district: '송파구',
    ...
    tags: ['indoor'],
    nearestStation: '2·5호선 잠실역 도보 5분',
  },
  {
    id: 'mock-30',
  ...
  {
    id: 'mock-35',
    slug: 'seodaemun-welfare-complex',
    sourceType: 'MOCK',
    name: '서대문종합사회복지관',
    category: 'welfare',
    district: '서대문구',
